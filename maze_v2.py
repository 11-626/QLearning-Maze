# https://blog.csdn.net/crystal_tyan/article/details/42523861
...
if __name__ == "__main__":
    ...
    maze = [[1 for col in range(2*sx+1)] for row in range(2*sy+1)]
    ...
    generateMaze((0, 0))
    maze_np = np.array(maze, dtype=np.uint8)
    # print(maze_np)
    plt.imshow(maze_np, cmap="gray", interpolation="none")
    plt.show()
